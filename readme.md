...
All projects are developed using frameworks such as [TensorFlow](https://www.tensorflow.org/api_docs), [PyTorch](https://pytorch.org/docs/stable/index.html) (including its [PyTorch/XLA](https://github.com/pytorch/xla) backend), [Hugging Face](https://huggingface.co/), and [Ultralytics](https://docs.ultralytics.com/). For training, evaluation, and inference, **Google Colab** and **Kaggle** platforms are leveraged, scaling from **single-GPU** setups to distributed training on **multi-GPU** and **multi-core TPU** systems. This is achieved through the native distributed strategies of **TensorFlow** and **PyTorch**, ensuring scalability and efficient resource utilization.
